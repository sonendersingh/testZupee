...
class AddTournament{
		...
		public void postRequestOnce()
		{
			  Map<String, String> bodyParams= new HashMap<String, String>();
				...
				bodyParams.put("name", "sonender Singh");
				bodyParams.put("entry", "1");
				bodyParams.put("numQuestions", "1");
				bodyParams.put("startTime", "");
				bodyParams.put("endTime", "");
			
				resp= resp1.postAPICall("http://misc.zupee.in","/miniTournament/addTournament/",3000,"Application/json",null, bodyParams);	
